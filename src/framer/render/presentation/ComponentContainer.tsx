 ...
 * @internal
 */
export interface ComponentContainerProps<Component extends React.Component>
...
export class ComponentContainer extends Layer<ComponentContainerProperties, ComponentContainerState> {
    ...
    static defaultProps: ComponentContainerProperties = Object.assign(
        {},
    ...
    render() {
        ...
        resetComponentTimeBudget()
        return <Frame {...this.properties}>{children}</Frame>
    }
}
