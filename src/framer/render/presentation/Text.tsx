...
export class Text extends Layer<TextProperties, {}> {
    ...
    static defaultProps: TextProperties = Object.assign({}, Layer.defaultLayerProps, Text.defaultTextProps)
    ...
    editorStateForContentState(contentState?: ContentState | RawDraftContentState) {
        if (contentState) {
