...
import { subtract } from "../utils/point"
...
export class FramerEvent {
     ...
     */
    velocity(t: number) {
        return this.session.velocity(t)
    }
     ...
     */
    get offset() {
        return this.session.offset(this)
    }
