...
import { Frame, FrameProperties } from "../components/Frame"
...
export interface Props {
    ...
    contextSize: Size
    contentSize: Size
    initialProps: Partial<FrameProperties>
    transitionProps: Partial<FrameProperties>
...
export type AnimatingProperties = Partial<FrameProperties> & { dimOpacity: number }
    ...
    render() {
        ...
        return (
            ...
            >
                ...
                />
                <Frame
                    {...observedFrameProps as FrameProperties}
...
const allAnimatableProperties: Partial<FrameProperties> & { dimOpacity: number } = {
    top: 0,
    left: 0,
    z: 0,
    rotation: 0,
